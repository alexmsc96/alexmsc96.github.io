...
function nextDaysWeather (data) {
    ...
    document.querySelector('.day-1-temperature').textContent = `${data.list[9].main.temp} °C`;
    document.querySelector('.day-1-feel').textContent = `feels like ${data.list[9].main.feels_like} °C`;
    ...
    document.querySelector('.day-2-temperature').textContent = `${data.list[17].main.temp} °C`;
    document.querySelector('.day-2-feel').textContent = `feels like ${data.list[17].main.feels_like} °C`;
    ...
    document.querySelector('.day-3-temperature').textContent = `${data.list[25].main.temp} °C`;
    document.querySelector('.day-3-feel').textContent = `feels like ${data.list[25].main.feels_like} °C`;
    ...
    document.querySelector('.day-4-temperature').textContent = `${data.list[33].main.temp} °C`;
    document.querySelector('.day-4-feel').textContent = `feels like ${data.list[33].main.feels_like} °C`;
